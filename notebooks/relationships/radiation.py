...
@app.cell
def _(DatasetStore, F, all_variables, platform_root, raw_root, source_control, spark):
...
def _(
    ...
    return analysis_sdf, selected_end, selected_start
...
def _(F, all_variables, analysis_sdf, focus_control, math, pd):
    ...
    return comparison_variables, focus_variable, relationships
...
def _(alt, focus_variable, mo, relationships, top_n_control):
    ...
    return correlation_chart, correlation_widget
...
def _(
    ...
    return scatter_long, scatter_wide, selected_comparisons
...
def _(alt, focus_variable, grid_columns_control, mo, scatter_long):
    ...
    regression = (
        ...
        .transform_regression(
            "comparison_value",
            focus_variable,
            groupby=["comparison_variable"],
        )
        .mark_line(color="#111827", strokeWidth=3)
        .encode(
            x=alt.X("comparison_value:Q"),
            y=alt.Y(f"{focus_variable}:Q"),
        )
    )
    scatter_chart = (
    ...
    mo.vstack(
        [
            mo.md(
                ...
                "legend item to isolate a location and hover for exact values. Black lines are "
                "separate pooled linear fits."
            ),
            scatter_widget,
        ]
    )
    return scatter_chart, scatter_widget


@app.cell
def _(F, all_variables, pd, sliced_sdf):
    elevation_sdf = (
    ...
    return elevation_long, elevation_wide
...
def _(alt, elevation_long, grid_columns_control, mo):
    ...
    return elevation_chart, elevation_widget
...
def _(
    ...
    return temporal_long, temporal_variables
...
def _(alt, grid_columns_control, mo, temporal_long, time_grain_control):
    ...
    return temporal_chart, temporal_widget
