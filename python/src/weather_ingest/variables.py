"""Pinned historical hourly profile; see docs/regional-study.md for scope and units."""

ARCHIVE_VARIABLES = tuple('''temperature_2m relative_humidity_2m dew_point_2m
apparent_temperature precipitation rain snowfall snow_depth weather_code pressure_msl
...
soil_moisture_100_to_255cm boundary_layer_height wet_bulb_temperature_2m
 total_column_integrated_water_vapour is_day sunshine_duration shortwave_radiation
 ...
 terrestrial_radiation_instant'''.split())
MODEL = "era5_seamless"
