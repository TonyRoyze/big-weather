...
def main():
    ...
    processing.add_argument("--input", type=Path, default=Path("data/regional-2020-2025/raw"))
    processing.add_argument("--output", type=Path, default=Path("data/regional-2020-2025/processed"))
    publication = sub.add_parser("publish")
    publication.add_argument("--data-root", type=Path, default=Path("data/regional-2020-2025"))
